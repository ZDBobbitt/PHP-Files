<?php
/*
 *Template Name: SP500 Super Deep Dive
...
<script type="text/javascript" src="http://www.fourpillarfreedom.com/wp-content/themes/wisteria/js/d3-grid.js"></script>
<script type="text/javascript" src="http://www.fourpillarfreedom.com/wp-content/themes/wisteria/js/d3-comparator.js"></script>
...
<body>
	  ...
	  <h1 style='color: #c73d3d'>Visualizing the S&P 500</h1>
	  <hr style='margin-top: 30px; max-width: 75%; border-color: black'>
		  <h4 id='subTitle', style='color: #142849'><strong>An Exploration of Warren Buffett's Favorite Stock Market Index</strong></h4>
	  <hr style='margin-bottom: 40px; max-width: 75%; border-color: black'>
	  	  <img src="http://www.fourpillarfreedom.com/wp-content/themes/wisteria/sp500_circles.png" alt="S&P 500 Circles" style='margin-left: 5%'>
		  ...
		  <p>Warren Buffett is a longtime advocate of the S&P 500, claiming most common investors are better off investing in an S&P 500 index fund instead of actively managed stock market funds.</p>
		  <p>Today I want to explore the stocks that make up the S&P 500 and highlight some interesting facts about the size of some of these stocks in relation to each other.</p>
		  <p>Let's dive in!</p>
	 ...
	 <div id='graph1_block'><!--start of graph 1 block-->
		 ...
		 <div id='block_intro'>
		  <h3 id='subTitle' style='color: #142849'><strong>Visualizing Every Stock in the S&P 500 as Tiny Circles</strong></h3>
		  <hr style='margin-bottom: 40px; max-width: 75%;  border-color: black'>
		 </div>
		 
		 <div id='intro'>
			 <p>To visualize every single stock in the S&P 500, I use tiny circles. Each of the 506 circles below represents a unique stock. Some companies issue more than one 'class' of stock, which explains why there are more than 500 stocks total. An
			 example of this is Under Armour, who has both 'Class A' and 'Class C' stocks.</p>
			 <p>The size of the circle represents the market cap of the stock and the color represents the economic industry the stock is in. Hover over individual circles to display information about the stock.</p>
	  	     <h4 style='margin-bottom: 5px; margin-top: 40px'>SORT STOCKS BY</h4>
	    ...
	    <div id='graph1'></div>
		<div id='intro'>
		<h3 id='subTitle' style='color: #142849'><strong>Some Interesting Observations</strong></h3>
		<hr style='margin-bottom: 40px; max-width: 75%;  border-color: black'>
		<p>The three largest stocks in the S&P 500 are all in the Information Technology Industry: Apple, Microsoft, and Facebook. These three giants alone make up over 8% of the entire S&P 500. </p>
		<p>When sorting the stocks by market cap, it becomes apparent just how massive the largest stocks are in comparison to their peers. For example, Apple is over <i>five times larger</i>
		than Walt Disney Company and <i>six times larger</i> than McDonald's.</p>
		<p>It's also interesting to sort the stocks by industry. For example, there are only four stocks in the entire index that come from the Telecommunications industry, two of these being cellphone provider giants AT&T and Verizon.</p>
        <p>The industry with the smallest stocks, on average, is real estate. Those are the tiny yellow circles. Conversely, the industry with the largest stocks, on average, is information technology.</p>
		<p>For me, the most surprising aspect of this visualization is just how large some of these stocks are in comparison to others. Some houshold company names like Goodyear Tire and Tractor Supply look like Mom and Pop shops compared
		to some of the tech companies. Let's take a closer look at just how large (and how small) these companies are in relation to each other...</p>
		<p class='last_block_p'>&nbsp;</p>
		</div>
	 ...
	 <div id='graph2_block'><!--start of graph 2 block-->
		 ...
		 <div id='block_intro'>
		  <h3 id='subTitle' style='color: #142849'><strong>A Closer Look at the Behemoths</strong></h3>
		  <hr style='margin-bottom: 40px; max-width: 75%;  border-color: black'>
		 </div>
		 
		 <div id='intro'>
		     <h2 class='sectionTitle'>Apple</h2>
			 <p>The largest stock in the S&P 500 is Apple. It's massive.</p>
			  <div id='graph2'></div>
			 <p>In fact, it's so large that it's equal in size to the 109 smallest stocks in the S&P 500. (Hover over each tiny circle below to see the names of these 109 stocks)</p>
			 <div id='graph22'></div>
			 <p>What makes this so incredible is that the names of some of these so called "small" stocks 
			 are well-known companies, including Macy's, Chipotle, and Advance Auto Parts.</p>
			 <p class='last_block_p'>&nbsp;</p>
			 
			 <h2 class='sectionTitle'>The Three Tech Giants</h2>
			 <p>The three largest stocks are Apple, Microsoft, and Facebook. Together they compose 8.42% of the entire S&P 500.</p>
			  <div id='graph23'></div>
			 <p>They're equivalent in size to the smallest 191 stocks in the index.</p>
			 <div id='graph24'></div>
			 
			 <h2 class='sectionTitle'>The Top Ten</h2>
			 <p>The ten largest stocks make up nearly 20% of the entire S&P 500.</p>
			  <div id='graph25'></div>
			 <p>These ten are equivalent in size to the smallest 311 stocks in the index.</p>
			 <div id='graph26'></div>
		 
		    <h2 class='sectionTitle'>Not as Diversified as Advertised</h2>
			<p>One of the reasons many investors like the S&P 500 is because it offers a "diversified" method of investing, since buying a single share in the S&P 500 exposes you to 506 unique stocks.
			 This mitigates some of the risk that inherently comes with investing in a single stock. But from the visualizations here we can see that the S&P 500 might not be <i>quite</i> as diversified as you think.</p>
             <p>Due to the weighted nature of the index,
			 many of the large companies make up a disproportionately large percentage of the index.
			 This means a bad year for Apple would have a considerably larger impact on the performance of this index fund compared to a bad year for Royal Caribbean Cruises.</p>
			 <p>The S&P 500 is also top-heavy with information technology stocks, which means it isn't as diversified across economic industries as investors might think. This may or may not be a bad thing depending on how this individual industry performs.</p>
			 <p>Hopefully this exploration offers an insightful look at the exact composition of the stock market fund that Warren Buffett loves so much.</p>
			<p class='last_block_p'>&nbsp;</p>
		</div>
	 ...
	 <div id='intro'><!--start of intro-->
	  <h4 id='subTitle', style='color: #142849'><strong>Notes</strong></h4>
	  <hr style='margin-bottom: 40px; max-width: 75%; border-color: black'>
		  <p style='font-size: 14px;'>The stock weightings used in this analysis were current as of September 10th, 2017. All information about stock names, industry, and market cap size can be publicly found on Yahoo Finance.</p>
		  <p style='font-size: 14px'>I used Microsoft Excel and R to prepare the data for this analysis. I used vanilla javascript and D3.js for all visualizations and interactive features. For the sorting functionality in the first graph I utilized <a href="https://github.com/interactivethings/d3-comparator/blob/master/d3-comparator.js" target="_blank">the comparator function</a> and <a href="https://github.com/interactivethings/d3-grid/blob/master/d3-grid.js" target="_blank">the grid layout function</a> created by <a href="https://github.com/herrstucki" target="_blank">Jeremy Stucki</a>.</p>
	 </div><!--end of intro-->
...
<pre id='techThreeData'>
Company,size,Sector,id,color,y
Apple Inc.,3.814297,Information Technology,50,#43e8d8,107.5
Microsoft Corporation,2.703617,Information Technology,200,#43e8d8,113
Facebook Inc. Class A,1.902894,Information Technology,350,#43e8d8,101.5</pre>

<pre id='topTenData'>
Company,size,Sector,id,color,y
Apple Inc.,3.814297,Information Technology,10,#43e8d8,107.5
Microsoft Corporation,2.703617,Information Technology,55,#43e8d8,113
Facebook Inc. Class A,1.902894,Information Technology,95,#43e8d8,101.5
Amazon.com Inc.,1.799505,Consumer Discretionary,127,#dfdfdf,149.5
Johnson & Johnson,1.688643,Health Care,155,#ff5757,53.5
Berkshire Hathaway Inc. Class B,1.639008,Financials,180,#d975f8,65
Exxon Mobil Corporation,1.581928,Energy,205,#88ff8b,73
JPMorgan Chase & Co.,1.537914,Financials,230,#d975f8,136
Alphabet Inc. Class A,1.297788,Information Technology,255,#43e8d8,112
Alphabet Inc. Class C,1.295076,Information Technology,280,#43e8d8,64.5
</pre>
...
var techThreeData = d3.csv.parse(d3.select("pre#techThreeData").text() );
var topTenData = d3.csv.parse(d3.select("pre#topTenData").text() );
...
function update() {
  ...
  var svg22 = d3.select("#graph22")
	  .append("div")
	  .classed("svg-container3", true)
	  .append("svg")
	  .attr("preserveAspectRatio", "xMinYMin meet")
	  .attr("viewBox", "0 0 525 225")
	   //class to make it responsive
	  .classed("svg-content-responsive", true)
	  .append("g")
	  .attr("transform", "translate(250, 90)");
  
  var svg23 = d3.select("#graph23")
      .append("div")
	  .classed("svg-container2", true)
	  .append("svg")
	  .attr("preserveAspectRatio", "xMinYMin meet")
  ...
  var svg26 = d3.select("#graph26")
      .append("div")
	  .classed("svg-container", true)
	  .append("svg")
	  .attr("preserveAspectRatio", "xMinYMin meet")
	  .attr("viewBox", "0 0 575 800")
	   //class to make it responsive
	  .classed("svg-content-responsive", true)
	  .append("g")
      .attr("transform", "translate(270, 180)");
	
	var apple = svg2.selectAll("circle.node")
		.data(data)
        .enter().append("circle")
		.filter(function (d) { return d.Company === 'Apple Inc.'; })
		...
		var small_109 = svg22.selectAll("circle.node")
		.data(data)
        .enter().append("circle")
		.filter(function (d) { return d.size < 0.0485; })
	    .attr("cx", function(d) { return radius * (Math.cos(d.id/70)+Math.random()*.35);})
	    .attr("cy", function(d) { return radius * (Math.sin(d.id/70)+Math.random()*.35);})
	    .attr("r", function(d) { return d.size * 60;})
		.attr("class", "planet")
		.style("fill", function(d) { return d.color; })
		.style("stroke", "black")
        .on("mouseover", function(d) {		
		...
		var techThree = svg23.selectAll("circle.node")
		.data(techThreeData)
        .enter().append("circle")
	    .attr("cx", function(d) { return d.id/2 - 40;})
		...
		var small_191 = svg24.selectAll("circle.node")
		.data(data)
        .enter().append("circle")
		.filter(function (d) { return d.size < 0.0656; })
	    .attr("cx", function(d) { return radius2 * (Math.cos(d.id/70)+Math.random()*.35);})
	    .attr("cy", function(d) { return radius2 * (Math.sin(d.id/70)+Math.random()*.35);})
	    .attr("r", function(d) { return d.size * 60;})
		.attr("class", "planet")
		.style("fill", function(d) { return d.color; })
		.style("stroke", "black")
		...
		var topTen = svg25.selectAll("circle.node")
		.data(topTenData)
        .enter().append("circle")
		...
		var small_311 = svg26.selectAll("circle.node")
		.data(data)
        .enter().append("circle")
		.filter(function (d) { return d.size < 0.121; })
	    .attr("cx", function(d) { return radius3 * (Math.cos(d.id/70)+Math.random()*.5);})
	    .attr("cy", function(d) { return radius3 * (Math.sin(d.id/70)+Math.random()*.5);})
	    .attr("r", function(d) { return d.size * 60;})
		.attr("class", "planet")
		.style("fill", function(d) { return d.color; })
		.style("stroke", "black")
        ...
        svg22.selectAll(".planet").attr("transform", function(d) {
          return "rotate(" + 100 + delta * .01 + ")";
        });
		svg24.selectAll(".planet").attr("transform", function(d) {
          return "rotate(" + 100 + delta * .01 + ")";
        });
		svg26.selectAll(".planet").attr("transform", function(d) {
          return "rotate(" + 100 + delta * .01 + ")";
        });
      });
