<?php
/*
 *Template Name: Median Household Income By State
...
<div>
	<h2 id='titleWords'>Visualizing Median Household Income By State</h2>
	<hr>
	<p id='overview'>The map below shows the median household income in all 50 U.S. states. Data for this visual comes from the <a href='https://factfinder.census.gov/faces/nav/jsf/pages/index.xhtml' target='_blank'>2016 American Community Survey</a>.</p>
	<p id='overview'><b>Some interesting observations:</b></p>
	<p id='overview'>The state with the highest median household income is Maryland at $76,067.</p>
	<p id='overview'>The state with the lowest median household income is Mississippi at $40,528.</p>
	<p id='overview'>In general, household incomes are highest among northeastern states and lowest among southeastern states.</p>
	<p id='overview'>Perhaps the biggest surprise for me is seeing that Minnesota is one of the highest household income states, surpassing New York and rivaling California.</p>
...
<div class="nc_tweetContainer twitter" data-id="2" data-network="twitter"><a rel="nofollow" target="_blank" href="https://twitter.com/share?original_referer=/&text=Visualizing Median Household Income By State&url=http://www.fourpillarfreedom.com/visualizing-median-household-income-by-state/&via=4PillarFreedom" data-link="https://twitter.com/share?original_referer=/&text=Visualizing Median Household Income By State&url=http://www.fourpillarfreedom.com/visualizing-median-household-income-by-state/&via=4PillarFreedom" class="nc_tweet"><span class="swp_count swp_hide"><span class="iconFiller"><span class="spaceManWilly"><i class="sw sw-twitter"></i><span class="swp_share"> Tweet</span></span></span></span></a></div>
<div class="nc_tweetContainer swp_fb" data-id="3" data-network="facebook"><a rel="nofollow" target="_blank" href="https://www.facebook.com/share.php?u=http%3A%2F%2Fwww.fourpillarfreedom.com%2Fvisualizing-median-household-income-by-state%2F" data-link="http://www.facebook.com/share.php?u=http%3A%2F%2Fwww.fourpillarfreedom.com%2Fvisualizing-median-household-income-by-state%2F" class="nc_tweet"><span class="iconFiller"><span class="spaceManWilly"><i class="sw sw-facebook"></i><span class="swp_share"> Share</span></span></span><span class="swp_count">1</span></a></div>
...
d3.csv("https://raw.githubusercontent.com/ZDBobbitt/Maps/master/medianHouseholdIncomeByState.csv", function(data) {
	...
	for (var d = 0; d < data.length; d++) {
		dataArray.push(parseFloat(data[d].medianHouseholdIncome))
	}
  ...
  d3.json("https://raw.githubusercontent.com/ZDBobbitt/Maps/master/us-states.json", function(json) {
    ...
    svg.selectAll("path")
      ...
      .style("fill", function(d){ return colorScale(d.properties.medianHouseholdIncome)})
            .on("mouseover", function(d) {
            d3.select(this).style("opacity", .7)	  	  
            div.transition()		
                .duration(200)		
                .style("opacity", .95);		
            div .html("<b>State:</b> " + d.properties.name + "<br/> <b>Median Household Income:</b> " + "$" + d.properties.medianHouseholdIncome.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","))	
